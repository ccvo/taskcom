 ...
 * @author Chuong Vo
 */
public final class GetLightStatus extends HttpServlet implements Constants {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                if (rs.next()) {
                    if (rs.getInt("isON") == 1) {
                        out.println("<h1>Light is ON!</h1>");
                    } else {
                        out.println("<h1>Light is OFF!</h1>");
                    }
                } else {
                    out.println("Light not found!!!");
                }
